...
Camera::Camera() :
    has_camera(false), camera_started(false), stream(nullptr), camera(nullptr), camera_manager(nullptr),
    exposure_time(12000), analogue_gain(1), brightness(0.f), contrast(1.f), saturation(1.f), lens_position(0.f),
    temperature(0.f), lines_per_row(0), padding(0) {
...
//[1:21:54.277936882] [2448]  WARN RPiSdn sdn.cpp:40 Using legacy SDN tuning - please consider moving SDN inside
// rpi.denoise [1:21:54.283708309] [2448]  INFO RPI vc4.cpp:447 Registered camera /base/soc/i2c0mux/i2c@1/imx477@1a to
// Unicam device /dev/media3 and ISP device /dev/media0 name: /base/soc/i2c0mux/i2c@1/imx477@1a Camera
// /base/soc/i2c0mux/i2c@1/imx477@1a acquired Default stillcapture configuration is: 4056x3040-YUV420 Validated
// stillcapture configuration is: 4056x3040-YUV420 [1:22:01.797244530] [2442]  INFO Camera camera.cpp:1202 configuring
// streams: (0) 4056x3040-YUV420 [1:22:01.798293057] [2448]  INFO RPI vc4.cpp:622 Sensor:
/// base/soc/i2c0mux/i2c@1/imx477@1a - Selected sensor format: 4056x3040-SBGGR12_1X12 - Selected unicam format:
// 4056x3040-pBCC
...
bool Camera::configure_camera(const int &format_index, const int &size_index) {
    ...
    //[125:45:39.931733241] [13488]  WARN RPiSdn sdn.cpp:40 Using legacy SDN tuning - please consider moving SDN inside
    // rpi.denoise [125:45:39.937583623] [13488]  INFO RPI vc4.cpp:447 Registered camera
    /// base/soc/i2c0mux/i2c@1/imx477@1a to Unicam device /dev/media3 and ISP device /dev/media0 [125:45:39.937748777]
    //[13488]  INFO RPI pipeline_base.cpp:1121 Using configuration file
    //'/usr/share/libcamera/pipeline/rpi/vc4/rpi_apps.yaml' Made QT preview window Mode selection for 2028:1520:12:P
    ...
    //[125:45:45.447248957] [13485]  INFO Camera camera.cpp:1202 configuring streams: (0) 2028x1520-YUV420 (1)
    // 2028x1520-SBGGR12_CSI2P [125:45:45.448189308] [13488]  INFO RPI vc4.cpp:622 Sensor:
    /// base/soc/i2c0mux/i2c@1/imx477@1a - Selected sensor format: 2028x1520-SBGGR12_1X12 - Selected unicam format:
    // 2028x1520-pBCC
...
bool Camera::start_camera() {
    ...
    // (https://github.com/libcamera-org/libcamera/blob/master/src/libcamera/control_ids_core.yaml)
